...
int main (int argc, char *argv[])
{
    ...
    int Asize = A_sz * sizeof(float);
    int Bsize = B_sz * sizeof(float);
    int Csize = C_sz * sizeof(float);
    ...
    cudaMemcpy(B_d, B_h, Bsize, cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(C_h, C_d, Csize, cudaMemcpyDeviceToHost);
